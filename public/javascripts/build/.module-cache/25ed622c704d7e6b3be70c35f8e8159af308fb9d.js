...
//console.log("===========");
//data.map(function(x) {console.log(x);});
//cities.map(function(x) {console.log(x);});

  // redraw the line, and slide it to the left
   //city.transition().duration(500).ease("linear");

   city.transition().duration(500).remove("linear");
